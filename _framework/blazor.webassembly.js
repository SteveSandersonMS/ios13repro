        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    started = true;
                    RendererEventDispatcher_1.setEventDispatcher(function (eventDescriptor, eventArgs) { return DotNet.invokeMethodAsync('Microsoft.AspNetCore.Blazor', 'DispatchEvent', eventDescriptor, JSON.stringify(eventArgs)); });
                    ...
                    window['Blazor']._internal.navigationManager.listenForNavigationEvents(function (uri, intercepted) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, DotNet.invokeMethodAsync('Microsoft.AspNetCore.Blazor', 'NotifyLocationChanged', uri, intercepted)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
...
function attachInteropInvoker() {
    ...
    var dotNetDispatcherEndInvokeJSMethodHandle = findMethod('Mono.WebAssembly.Interop', 'Mono.WebAssembly.Interop', 'MonoWebAssemblyJSRuntime', 'EndInvokeJS');
    DotNet.attachDispatcher({
        ...
        endInvokeJSFromDotNet: function (asyncHandle, succeeded, serializedArgs) {
            exports.monoPlatform.callMethod(dotNetDispatcherEndInvokeJSMethodHandle, null, [exports.monoPlatform.toDotNetString(serializedArgs)]);
        },
